...
class Actor:
    ...
    def __init__(self, state_space):
        ...
        i = Dense(256, activation='elu', use_bias=True)(state_input)
        #i = GaussianNoise(1.0)(i)
        i = Dense(128, activation='elu', use_bias=True)(i)
        #i = GaussianNoise(1.0)(i)

        # vystupna vrstva
        out = Dense(1, activation='tanh', use_bias=True)(i)
